...
const AccountItem: React.FC<{
  ...
  const handleClick = useCallback(() => {
    if (partOfList) {
      void apiRequestDelete(`v1/lists/${listId}/accounts`, {
        account_ids: [accountId],
      });
    } else {
      void apiRequestPost(`v1/lists/${listId}/accounts`, {
        account_ids: [accountId],
      });
    }
...
const ListMembers: React.FC<{
  ...
  useEffect(() => {
    if (id) {
      ...
      void apiRequestGet<ApiAccountJSON[]>(`v1/lists/${id}/accounts`, {
        limit: 0,
      })
        .then((data) => {
    ...
    >
      ...
      {mode === 'remove' && (
        <div className='column-footer'>
          <div className='column-footer__inner'>
